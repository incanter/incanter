<a border="0" href="http://incanter.org" ><img src="http://incanter.org/images/incanter.png" alt="Incanter" /></a>
...
Motivation for a Lisp-based R-like statistical environment can be found in the paper "Back to the Future: Lisp as a Base for a Statistical Computing System":http://books.google.com/books?id=8Cf16JkKz30C&pg=PA21 by Ihaka and Lang (2008). 
...
From the Clojure shell, load the Incanter libraries: <pre><code>(use '(incanter core stats datasets charts))</code></pre>
