...
@java -jar incanter-bundle/target/incanter-exec.jar@
...
@java -Dincanter.home=/path/to/incanter/dir -jar incanter-bundle/target/incanter-exec.jar@
...
A Swank server can be started by running @mvn clojure:swank@, from the @incanter-bundle@ directory, which can be connected to with @M-x slime-connect@ within Emacs.
