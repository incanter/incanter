...
NOTE: If you want the latest version of Incanter, clone the repository with git, and run @lein/deps@ to download the necessary dependencies before using @script/repl@ (@repl.bat@) or @script/swank@ (@swank.bat@).
