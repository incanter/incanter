...
A pre-built version of Incanter that includes all the necessary dependencies can be downloaded at <a href="http://cloud.github.com/downloads/liebke/incanter/incanter-1.0rc.zip">http://cloud.github.com/downloads/liebke/incanter/incanter-1.0rc.zip</a>. If you would like to build it from source, read <a href="#build">Building Incanter</a>.
...
@mvn package@ to create incanter-1.0-SNAPSHOT.jar file in the ./target directory.
