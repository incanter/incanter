...
A pre-built version of Incanter can be downloaded at <a href="http://incanter.org/downloads/incanter.tar.gz">http://incanter.org/downloads/incanter.tar.gz</a>. If you would like to build it from source, read <a href="#build">Building Incanter</a>.
