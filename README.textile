...
A pre-built version of Incanter that includes all the necessary dependencies can be downloaded at <a href="http://cloud.github.com/downloads/liebke/incanter/incanter.zip">http://cloud.github.com/downloads/liebke/incanter/incanter.zip</a>. If you would like to build it from source, read <a href="#build">Building Incanter</a>.
