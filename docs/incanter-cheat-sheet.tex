...
\begin{tabularx}{\hsize}{lX}
Operations: & \cmd{plus minus mult div exp log log10 log2 pow sqr sq sum prod abs} \\
Trigonometry: & \cmd{cos sign tan acos asin atan} \\
Special fns: & \cmd{beta gamma regularized-beta incomplete-beta} \\
Misc. fns: & \cmd{choose factorial sum-of-squares solve-quadratic} \\
\end{tabularx}

}

\colouredbox{yellow}{
\section{Matrices \textmd{\textrm{(incanter.core)}}}
% \section{Matrices}
% \subsection{incanter.core}
\begin{tabularx}{\hsize}{lX}
...
Transformation: & \cmd{trans vectorize half-vectorize to-list to-vect} \\
Decomposition: & \cmd{decomp-cholesky decomp-eigenvalue decomp-lu decomp-qr decomp-svd} \\
View: & \cmd{view} \\
...
\colouredbox{green}{
\section{IO \textmd{\textrm{(incanter.io)}}}
\begin{tabularx}{\hsize}{lX}
...
\verb!$Revision: 1.00, $Date: October 21, 2009!\\
