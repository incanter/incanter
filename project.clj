(defproject incanter "1.5.1"
  ...
  :dependencies [[incanter/incanter-core "1.5.1"]
                 [incanter/incanter-io "1.5.1"]
                 [incanter/incanter-charts "1.5.1"]
                 [incanter/incanter-mongodb "1.5.1"]
                 [incanter/incanter-pdf "1.5.1"]
                 [incanter/incanter-svg "1.5.1"]
                 [incanter/incanter-latex "1.5.1"]
                 [incanter/incanter-excel "1.5.1"]
                 [incanter/incanter-sql "1.5.1"]
