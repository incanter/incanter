(defproject incanter "1.5.2-SNAPSHOT"
  ...
  :dependencies [[incanter/incanter-core "1.5.2-SNAPSHOT"]
                 [incanter/incanter-io "1.5.2-SNAPSHOT"]
                 [incanter/incanter-charts "1.5.2-SNAPSHOT"]
                 [incanter/incanter-mongodb "1.5.2-SNAPSHOT"]
                 [incanter/incanter-pdf "1.5.2-SNAPSHOT"]
                 [incanter/incanter-svg "1.5.2-SNAPSHOT"]
                 [incanter/incanter-latex "1.5.2-SNAPSHOT"]
                 [incanter/incanter-excel "1.5.2-SNAPSHOT"]
                 [incanter/incanter-sql "1.5.2-SNAPSHOT"]
                 [incanter/incanter-zoo "1.5.2-SNAPSHOT"]
