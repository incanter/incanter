(defproject incanter "1.9.2"
  ...
  :dependencies [[incanter/incanter-core "1.9.2"]
                 ...
                 [incanter/incanter-mongodb "1.9.2"]
                 [incanter/incanter-pdf "1.9.2"]
                 [incanter/incanter-svg "1.9.2"]
                 [incanter/incanter-latex "1.9.2"]
                 [incanter/incanter-excel "1.9.2"]
                 [incanter/incanter-sql "1.9.2"]
                 [incanter/incanter-zoo "1.9.2"]
                 [swingrepl "1.3.0"
